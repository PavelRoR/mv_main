! function (e, i) {
    ...
    e.fn.lightSlider = function (i) {
        ...
        return P.chbreakpoint = function () {
            ...
            controls: function () {
                l.controls && (s.parent(l).after('<div class="lSAction"><a class="lSPrev">' + l.prevHtml + '</a><a class="lSNext">' + l.nextHtml + "</a></div>"), l.autoWidth ? P.calWidth(!1) < g && v.find(".lSAction").hide() : u <= l.item && v.find(".lSAction").hide(), v.parent().find(".lSAction a").on("click", function (i) {
            ...
            enableDrag: function () {
                ...
                if (!w) {
                    ...
                    v.find(".lightSlider").addClass("lsGrab"), v.on("mousedown", function (i) {
                        return !(g > f && 0 !== f) && void("lSPrev" !== e(i.target).attr("class") && "lSNext" !== e(i.target).attr("class") && (t = l.vertical === !0 ? i.pageY : i.pageX, a = !0, i.preventDefault ? i.preventDefault() : i.returnValue = !1, v.scrollLeft += 1, v.scrollLeft -= 1, v.find(".lightSlider").removeClass("lsGrab").addClass("lsGrabbing"), clearInterval(x)))
