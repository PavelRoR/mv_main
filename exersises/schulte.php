...
?>
	...
	<section class="game">
		<div class="container">
			...
			<p>Это упражнение помогает натренировать внимание. Внимание важно во всех аспектах жизни, в то числе и в эзотерически, экстрасенсорных
				практиках.</p>
			<p>При каждодневной тренировке (если подобных тренеровок прежде не было), на протяжении 2-3 недель, Вы заметите что концентрация
				Вашего внимание возрасла, станете меньше отвлекаться от важных процессов, начнете замечать в разы больше.</p>
			...
			<div class="col-sm-4">
				<div class="center">
					<a href="http://mastervision.su/tests/%D1%88%D1%83%D0%BB%D1%8C%D1%82%D0%B5-6%D1%856/" class="gbutton">Таблица 6х6</a>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="center">
					<a href="http://mastervision.su/tests/%D1%88%D1%83%D0%BB%D1%8C%D1%82%D0%B5-7%D1%857/" class="gbutton">Таблица 7х7</a>
				</div>
			</div>
			<div class="col-sm-2"></div>
		</div>
		...
		<div class="comments">
			<div class="container">
						...
						<div class="col-sm-4">
							<div class="odnbutton">
								...
								<script>
									...
									}(document, "ok_shareWidget", "<?php the_permalink() ?>", "{width:170,height:30,st:'rounded',sz:20,ck:3}");
								</script>
							</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="fb-comments" data-href="<?php the_permalink() ?>" data-width="auto" data-numposts="10" order_by="reverse_time"></div>
					</div>
				</div>
			</div>
		</div>
